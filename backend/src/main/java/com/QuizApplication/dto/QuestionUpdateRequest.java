...
public class QuestionUpdateRequest {
    ...
    @Size(max = 350 , message = "the option1 length must be less than 350, not more than 350")
    private String option1;

    @NotBlank(message = "option2 must not be blank or empty or null")
    @Size(max = 350 , message = "the option2 length must be less than 350, not more than 350")
    private String option2;

    @NotBlank(message = "option3 must not be blank or empty or null")
    @Size(max = 350 , message = "the option3 length must be less than 350, not more than 350")
    private String option3;

    @NotBlank(message = "option4 must not be blank or empty or null")
    @Size(max = 350 , message = "the option4 length must be less than 350, not more than 350")
    private String option4;

    @NotBlank(message = "rightAnswer must not be blank or empty or null")
    @Size(max = 350 , message = "the rightAnswer length must be less than 350, not more than 350")
    private String rightAnswer;

    //validate the difficultyLevel ensuring it equals Easy or Medium or Hard
    @DifficultyLevelValidation
    private String difficultyLevel;

    //Here I am ensuring that the size is not greater than 50 and it is not blank
    @Size(max = 50 , message = "the category length must be less than 50, not more than 50")
    @NotBlank
